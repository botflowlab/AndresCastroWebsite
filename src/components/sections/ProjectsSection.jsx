...
function ProjectsSection() {
  ...
  const projects = [
    ...
    { id: 'project2', title: '', location: '', image: '/images/home/project2.jpg' },
    { id: 'project3', title: '', location: '', image: '/images/home/project3.jpg' },
    { id: 'project4', title: '', location: '', image: '/images/home/project4.jpg' }
  ];
        ...
        {[...Array(12)].map((_, i) => (
          <div
            ...
            className={`absolute w-1 h-1 bg-white/20 rounded-full transition-all duration-[3000ms] ease-out ${
              animationStarted ? 'opacity-100 animate-pulse' : 'opacity-0'
            }`}
            style={{
      ...
      <div className="max-w-8xl mx-auto px-4 relative z-10">
        <div className="text-center mb-8">
          <div className={`transition-all duration-[2500ms] ease-out ${
            animationStarted ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-16'
          }`}>
            ...
            >
              <div className="absolute inset-0 bg-gray-800 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 transform translate-y-full group-hover:translate-y-0 transition-all duration-500">
                  <h3 className="text-white font-medium text-lg leading-tight">{project.title}</h3>
