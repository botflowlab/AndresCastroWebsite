...
export default function Experience() {
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-white to-gray-50 relative mb-20 mt-20">
              ...
              >
                ...
                <div className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pr-16' : 'md:pl-16'} pl-16 md:pl-0`}>
                  <div className="bg-white p-8 shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 className="text-3xl font-medium mt-2 mb-2">{item.type}</h3>
                    <h4 className="text-2xl text-gray-800 mb-2">{item.title}</h4>
                    <p className="text-xl text-gray-600">{item.institution}</p>
                    {item.specialization && (
                      <p className="text-lg text-gray-500 mt-2 italic">{item.specialization}</p>
                    )}
                  </div>
                </div>
              </div>
