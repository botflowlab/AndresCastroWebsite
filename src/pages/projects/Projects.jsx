  ...
  return (
    <div className="font-sans relative">
      ...
      <div className="hidden md:flex fixed right-0 top-12 h-screen w-1/6 items-center justify-center text-align-right z-0 pointer-events-none">
        <div className="-rotate-90 text-[160px] opacity-30 text-left font-bold whitespace-nowrap text-transparent" style={{ WebkitTextStroke: '1px black', transform: 'scaleY(1.2)'}}>PROJECTS</div>
      </div>
     ...
     <div className="relative pt-24 z-10 mt-16 ml-16">
        ...
        <div className="md:ml-32">
          <div className="max-w-5xl mx-auto px-6 mt-12"> {/* <-- just this */}
            <main>
              <ProjectGrid />
            </main>
          </div>
