  ...
  return (
    <div className="font-sans relative">
     ...
     <div className="relative pt-24 z-10 mt-16">
        {/* Sidebar */}
        <div className="hidden md:block absolute left-0 top-24 w-64 h-full z-20 px-6 pt-6 mr-372">
          <Sidebar />
        </div>
      
        {/* Main Content */}
        <div className="md:ml-32">
          <div className="max-w-4xl md:max-w-5xl mx-auto px-6 mt-12"> {/* <-- just this */}
            <main>
              <ProjectGrid />
            </main>
          </div>
