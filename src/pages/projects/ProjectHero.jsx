    ...
    <div className="w-full flex flex-col mt-20 p-6">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-x-0 bottom-1/2 flex items-center justify-between px-4 md:px-8 pointer-events-none transform translate-y-1/2">
          <button
            onClick={prevImage}
            className="pointer-events-auto border border-white 1px bg-white/0 hover:bg-white text-black p-3 md:p-5 rounded-full shadow-xl transition-all duration-300 transform hover:scale-110"
